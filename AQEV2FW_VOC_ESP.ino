...
#define EEPROM_TEMPERATURE_OFFLINE_OFFSET (EEPROM_DISABLE_SOFTAP - 4)
...
#define EEPROM_BACKUP_TEMPERATURE_OFFLINE_OFFSET (EEPROM_BACKUP_RESISTANCE_CAL_OFFSET + 4)
...
#define EEPROM_BACKUP_ECO2_SENSITIVITY   (EEPROM_BACKUP_MQTT_PASSWORD + 32)
...
#define BACKUP_STATUS_ECO2_CALIBRATION_BIT        (5)
...
void updateDisplayedSensors() {
    ...
    const uint8_t NUM_DISPLAY_PAGES = init_bmp280_ok ? 2 : 1;
